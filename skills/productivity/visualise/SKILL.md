...
Pick the most informative visual form for the input, generate a self-contained HTML file (no external requests), write it to `./.draekien/visualisations/<slug>.html`, and report the full path.
