...
# ///
"""
Reads and writes the skill-evals section of .draekien/.skillsrc.

Usage:
  uv run scripts/skillsrc.py --config <path> get
  uv run scripts/skillsrc.py --config <path> set <value>

get  — prints outputDir value (or default ".draekien/skill-evals" if absent)
