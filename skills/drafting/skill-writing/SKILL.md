---
name: skill-writing
description: Creates agent skill following Agent Skills open standard (agentskills.io). Use when building/scaffolding a skill or user says "create a skill", "make a skill", "new skill", "scaffold a skill".
