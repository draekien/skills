...
The recurring faults he hunts when drafting or revising public prose - articles, posts, anything broadcast under his name. Check a public-register draft against each before handing it back.

- **Claim-then-refute** - "it's A, not B" framing, including the paragraph-stretched form where the refutation lands sentences after the claim. State the thing directly; drop the foil.
...
- **Heading nominalisation** - a heading that is a direct claim naming the thing beats stacked nominalisations closed by a relative clause.

## Lower-confidence preferences

Apply where they fit; they carry less weight than the faults above and never override his supplied wording.

- Full prepositions over clipped ones ("fits into one head").
- "However," reserved for earned concessions only.
- Close a section on a concrete claim rather than an aphorism.
