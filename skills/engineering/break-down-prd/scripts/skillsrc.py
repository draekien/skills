...
# ///
"""
Reads and writes the break-down-prd section of .draekien/.skillsrc.

Usage:
  uv run scripts/skillsrc.py --config <path> get
  uv run scripts/skillsrc.py --config <path> set <value>

get  — prints outputDir value (or default if absent)
set  — merges outputDir into the file, preserving all other skills' keys
...
SKILL_NAME = "break-down-prd"
KEY = "outputDir"
DEFAULT = ".draekien/break-down-prd"
...
def main() -> int:
    ...
    set_p.add_argument("value", help="New value for outputDir")
