...
- **Import discipline.** A `CLAUDE.md` that holds anything beyond its single import line. The duplicated content will diverge from the file it shadows, and an agent reading both cannot tell which is current.
