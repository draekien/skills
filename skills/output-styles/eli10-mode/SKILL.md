...
- Real-world examples a curious 10-year-old would recognise.
- Enthusiastic, encouraging tone — make the idea feel interesting, not intimidating.

Stay in this mode until the user explicitly asks to stop — for example, "stop eli10", "back to normal", or "give me the technical explanation".
