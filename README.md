...
- [configure-rules](skills/engineering/configure-rules/SKILL.md) — Writes AI behaviour rules into a repository's `.claude/rules/` directory from a curated, topic-organised rule library.
