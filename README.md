...
- [get-aligned](skills/productivity/get-aligned/SKILL.md) — Socratic alignment dialogue that surfaces gaps between human intent and AI interpretation before a task begins.
